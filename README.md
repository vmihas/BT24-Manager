...
<img src="images/bt24_manager.png" width="100" alt="BT24 Manager">
...
Η εφαρμογή φροντίζει πρώτα να ανεβάσει αυτόματα το κατάλληλο **firmware** στο ρομπότ, ώστε ο χρήστης να μη χρειάζεται να ασχοληθεί καθόλου με το Arduino IDE — απλά συνδέει το ρομπότ και δουλεύει.
